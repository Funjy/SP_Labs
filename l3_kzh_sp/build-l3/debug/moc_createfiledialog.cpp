...
#include "../../l3_kzh_sp/createfiledialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CreateFileDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 55, 21)
    ...
    "CreateFileDialog\0CreateComplete\0\0"
...
void CreateFileDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CreateFileDialog *_t = static_cast<CreateFileDialog *>(_o);
        switch (_id) {
        case 0: _t->CreateComplete(); break;
        ...
        {
            typedef void (CreateFileDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CreateFileDialog::CreateComplete)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CreateFileDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CreateFileDialog.data,
      qt_meta_data_CreateFileDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CreateFileDialog.stringdata))
        return static_cast<void*>(const_cast< CreateFileDialog*>(this));
...
// SIGNAL 0
void CreateFileDialog::CreateComplete()
{
